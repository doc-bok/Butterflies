...
public class ItemRegistry {
    ...
    public static final RegistryObject<Item> BUTTERFLY_NET = INSTANCE.register(ButterflyNetItem.EMPTY_NAME,
            () -> new ButterflyNetItem(new Item.Properties().stacksTo(1).tab(CreativeModeTab.TAB_MISC)));
    ...
    public static final RegistryObject<Item> BOTTLED_BUTTERFLY = INSTANCE.register(BottledButterflyItem.NAME,
            () -> new BottledButterflyItem(new Item.Properties().stacksTo(1).tab(CreativeModeTab.TAB_BUILDING_BLOCKS)));
    ...
    public static final RegistryObject<Item> ADMIRAL_BUTTERFLY_EGG = INSTANCE.register(ButterflyEggItem.ADMIRAL_NAME,
            () -> new ButterflyEggItem(Butterfly.ADMIRAL_NAME, new Item.Properties().tab(CreativeModeTab.TAB_MISC)));

    public static final RegistryObject<Item> BUCKEYE_BUTTERFLY_EGG = INSTANCE.register(ButterflyEggItem.BUCKEYE_NAME,
            () -> new ButterflyEggItem(Butterfly.BUCKEYE_NAME, new Item.Properties().tab(CreativeModeTab.TAB_MISC)));

    public static final RegistryObject<Item> CABBAGE_BUTTERFLY_EGG = INSTANCE.register(ButterflyEggItem.CABBAGE_NAME,
            () -> new ButterflyEggItem(Butterfly.CABBAGE_NAME, new Item.Properties().tab(CreativeModeTab.TAB_MISC)));

    public static final RegistryObject<Item> CHALKHILL_BUTTERFLY_EGG = INSTANCE.register(ButterflyEggItem.CHALKHILL_NAME,
            () -> new ButterflyEggItem(Butterfly.CHALKHILL_NAME, new Item.Properties().tab(CreativeModeTab.TAB_MISC)));

    public static final RegistryObject<Item> CLIPPER_BUTTERFLY_EGG = INSTANCE.register(ButterflyEggItem.CLIPPER_NAME,
            () -> new ButterflyEggItem(Butterfly.CLIPPER_NAME, new Item.Properties().tab(CreativeModeTab.TAB_MISC)));

    public static final RegistryObject<Item> COMMON_BUTTERFLY_EGG = INSTANCE.register(ButterflyEggItem.COMMON_NAME,
            () -> new ButterflyEggItem(Butterfly.COMMON_NAME, new Item.Properties().tab(CreativeModeTab.TAB_MISC)));

    public static final RegistryObject<Item> EMPEROR_BUTTERFLY_EGG = INSTANCE.register(ButterflyEggItem.EMPEROR_NAME,
            () -> new ButterflyEggItem(Butterfly.EMPEROR_NAME, new Item.Properties().tab(CreativeModeTab.TAB_MISC)));

    public static final RegistryObject<Item> FORESTER_BUTTERFLY_EGG = INSTANCE.register(ButterflyEggItem.FORESTER_NAME,
            () -> new ButterflyEggItem(Butterfly.FORESTER_NAME, new Item.Properties().tab(CreativeModeTab.TAB_MISC)));

    public static final RegistryObject<Item> GLASSWING_BUTTERFLY_EGG = INSTANCE.register(ButterflyEggItem.GLASSWING_NAME,
            () -> new ButterflyEggItem(Butterfly.GLASSWING_NAME, new Item.Properties().tab(CreativeModeTab.TAB_MISC)));

    public static final RegistryObject<Item> HAIRSTREAK_BUTTERFLY_EGG = INSTANCE.register(ButterflyEggItem.HAIRSTREAK_NAME,
            () -> new ButterflyEggItem(Butterfly.HAIRSTREAK_NAME, new Item.Properties().tab(CreativeModeTab.TAB_MISC)));

    public static final RegistryObject<Item> HEATH_BUTTERFLY_EGG = INSTANCE.register(ButterflyEggItem.HEATH_NAME,
            () -> new ButterflyEggItem(Butterfly.HEATH_NAME, new Item.Properties().tab(CreativeModeTab.TAB_MISC)));

    public static final RegistryObject<Item> LONGWING_BUTTERFLY_EGG = INSTANCE.register(ButterflyEggItem.LONGWING_NAME,
            () -> new ButterflyEggItem(Butterfly.LONGWING_NAME, new Item.Properties().tab(CreativeModeTab.TAB_MISC)));

    public static final RegistryObject<Item> MONARCH_BUTTERFLY_EGG = INSTANCE.register(ButterflyEggItem.MONARCH_NAME,
            () -> new ButterflyEggItem(Butterfly.MONARCH_NAME, new Item.Properties().tab(CreativeModeTab.TAB_MISC)));

    public static final RegistryObject<Item> MORPHO_BUTTERFLY_EGG = INSTANCE.register(ButterflyEggItem.MORPHO_NAME,
            () -> new ButterflyEggItem(Butterfly.MORPHO_NAME, new Item.Properties().tab(CreativeModeTab.TAB_MISC)));

    public static final RegistryObject<Item> RAINBOW_BUTTERFLY_EGG = INSTANCE.register(ButterflyEggItem.RAINBOW_NAME,
            () -> new ButterflyEggItem(Butterfly.RAINBOW_NAME, new Item.Properties().tab(CreativeModeTab.TAB_MISC)));

    public static final RegistryObject<Item> SWALLOWTAIL_BUTTERFLY_EGG = INSTANCE.register(ButterflyEggItem.SWALLOWTAIL_NAME,
            () -> new ButterflyEggItem(Butterfly.SWALLOWTAIL_NAME, new Item.Properties().tab(CreativeModeTab.TAB_MISC)));

    //  Spawn eggs
    private static final RegistryObject<Item> BUTTERFLY_MORPHO_EGG = INSTANCE.register(Butterfly.MORPHO_NAME,
            () -> new ForgeSpawnEggItem(EntityTypeRegistry.BUTTERFLY_MORPHO, 0x0000aa, 0x0088ff, new Item.Properties().tab(CreativeModeTab.TAB_MISC)));

    private static final RegistryObject<Item> BUTTERFLY_FORESTER_EGG = INSTANCE.register(Butterfly.FORESTER_NAME,
            () -> new ForgeSpawnEggItem(EntityTypeRegistry.BUTTERFLY_FORESTER, 0xeeee77, 0xff7777, new Item.Properties().tab(CreativeModeTab.TAB_MISC)));

    private static final RegistryObject<Item> BUTTERFLY_COMMON_EGG = INSTANCE.register(Butterfly.COMMON_NAME,
            () -> new ForgeSpawnEggItem(EntityTypeRegistry.BUTTERFLY_COMMON, 0xaaff66, 0xeeee77, new Item.Properties().tab(CreativeModeTab.TAB_MISC)));

    private static final RegistryObject<Item> BUTTERFLY_EMPEROR_EGG = INSTANCE.register(Butterfly.EMPEROR_NAME,
            () -> new ForgeSpawnEggItem(EntityTypeRegistry.BUTTERFLY_EMPEROR, 0xcc44cc, 0xffffff, new Item.Properties().tab(CreativeModeTab.TAB_MISC)));

    private static final RegistryObject<Item> BUTTERFLY_HAIRSTREAK_EGG = INSTANCE.register(Butterfly.HAIRSTREAK_NAME,
            () -> new ForgeSpawnEggItem(EntityTypeRegistry.BUTTERFLY_HAIRSTREAK, 0xcc44cc, 0x880000, new Item.Properties().tab(CreativeModeTab.TAB_MISC)));

    private static final RegistryObject<Item> BUTTERFLY_RAINBOW_EGG = INSTANCE.register(Butterfly.RAINBOW_NAME,
            () -> new ForgeSpawnEggItem(EntityTypeRegistry.BUTTERFLY_RAINBOW, 0xff7777, 0x0088ff, new Item.Properties().tab(CreativeModeTab.TAB_MISC)));

    private static final RegistryObject<Item> BUTTERFLY_HEATH_EGG = INSTANCE.register(Butterfly.HEATH_NAME,
            () -> new ForgeSpawnEggItem(EntityTypeRegistry.BUTTERFLY_HEATH, 0x880000, 0x000000, new Item.Properties().tab(CreativeModeTab.TAB_MISC)));

    private static final RegistryObject<Item> BUTTERFLY_GLASSWING_EGG = INSTANCE.register(Butterfly.GLASSWING_NAME,
            () -> new ForgeSpawnEggItem(EntityTypeRegistry.BUTTERFLY_GLASSWING, 0x880000, 0xffffff, new Item.Properties().tab(CreativeModeTab.TAB_MISC)));

    private static final RegistryObject<Item> BUTTERFLY_CHALKHILL_EGG = INSTANCE.register(Butterfly.CHALKHILL_NAME,
            () -> new ForgeSpawnEggItem(EntityTypeRegistry.BUTTERFLY_CHALKHILL, 0x0088ff, 0x00cc55, new Item.Properties().tab(CreativeModeTab.TAB_MISC)));

    private static final RegistryObject<Item> BUTTERFLY_SWALLOWTAIL_EGG = INSTANCE.register(Butterfly.SWALLOWTAIL_NAME,
            () -> new ForgeSpawnEggItem(EntityTypeRegistry.BUTTERFLY_SWALLOWTAIL, 0xffffff, 0xeeee77, new Item.Properties().tab(CreativeModeTab.TAB_MISC)));

    private static final RegistryObject<Item> BUTTERFLY_MONARCH_EGG = INSTANCE.register(Butterfly.MONARCH_NAME,
            () -> new ForgeSpawnEggItem(EntityTypeRegistry.BUTTERFLY_MONARCH, 0xdd8855, 0x000000, new Item.Properties().tab(CreativeModeTab.TAB_MISC)));

    private static final RegistryObject<Item> BUTTERFLY_CABBAGE_EGG = INSTANCE.register(Butterfly.CABBAGE_NAME,
            () -> new ForgeSpawnEggItem(EntityTypeRegistry.BUTTERFLY_CABBAGE, 0xeeee77, 0xffffff, new Item.Properties().tab(CreativeModeTab.TAB_MISC)));

    private static final RegistryObject<Item> BUTTERFLY_ADMIRAL_EGG = INSTANCE.register(Butterfly.ADMIRAL_NAME,
            () -> new ForgeSpawnEggItem(EntityTypeRegistry.BUTTERFLY_ADMIRAL, 0x880000, 0x0088ff, new Item.Properties().tab(CreativeModeTab.TAB_MISC)));

    private static final RegistryObject<Item> BUTTERFLY_LONGWING_EGG = INSTANCE.register(Butterfly.LONGWING_NAME,
            () -> new ForgeSpawnEggItem(EntityTypeRegistry.BUTTERFLY_LONGWING, 0x000000, 0xffffff, new Item.Properties().tab(CreativeModeTab.TAB_MISC)));

    private static final RegistryObject<Item> BUTTERFLY_CLIPPER_EGG = INSTANCE.register(Butterfly.CLIPPER_NAME,
            () -> new ForgeSpawnEggItem(EntityTypeRegistry.BUTTERFLY_CLIPPER, 0x0044aa, 0x004488, new Item.Properties().tab(CreativeModeTab.TAB_MISC)));

    private static final RegistryObject<Item> BUTTERFLY_BUCKEYE_EGG = INSTANCE.register(Butterfly.BUCKEYE_NAME,
            () -> new ForgeSpawnEggItem(EntityTypeRegistry.BUTTERFLY_BUCKEYE, 0xcccc88, 0x8888cc, new Item.Properties().tab(CreativeModeTab.TAB_MISC)));

    //  Spawn eggs
    private static final RegistryObject<Item> CATERPILLAR_MORPHO_EGG = INSTANCE.register(Caterpillar.MORPHO_NAME,
            () -> new ForgeSpawnEggItem(EntityTypeRegistry.CATERPILLAR_MORPHO, 0x0000aa, 0x0088ff, new Item.Properties().tab(CreativeModeTab.TAB_MISC)));

    private static final RegistryObject<Item> CATERPILLAR_FORESTER_EGG = INSTANCE.register(Caterpillar.FORESTER_NAME,
            () -> new ForgeSpawnEggItem(EntityTypeRegistry.CATERPILLAR_FORESTER, 0xeeee77, 0xff7777, new Item.Properties().tab(CreativeModeTab.TAB_MISC)));

    private static final RegistryObject<Item> CATERPILLAR_COMMON_EGG = INSTANCE.register(Caterpillar.COMMON_NAME,
            () -> new ForgeSpawnEggItem(EntityTypeRegistry.CATERPILLAR_COMMON, 0xaaff66, 0xeeee77, new Item.Properties().tab(CreativeModeTab.TAB_MISC)));

    private static final RegistryObject<Item> CATERPILLAR_EMPEROR_EGG = INSTANCE.register(Caterpillar.EMPEROR_NAME,
            () -> new ForgeSpawnEggItem(EntityTypeRegistry.CATERPILLAR_EMPEROR, 0xcc44cc, 0xffffff, new Item.Properties().tab(CreativeModeTab.TAB_MISC)));

    private static final RegistryObject<Item> CATERPILLAR_HAIRSTREAK_EGG = INSTANCE.register(Caterpillar.HAIRSTREAK_NAME,
            () -> new ForgeSpawnEggItem(EntityTypeRegistry.CATERPILLAR_HAIRSTREAK, 0xcc44cc, 0x880000, new Item.Properties().tab(CreativeModeTab.TAB_MISC)));

    private static final RegistryObject<Item> CATERPILLAR_RAINBOW_EGG = INSTANCE.register(Caterpillar.RAINBOW_NAME,
            () -> new ForgeSpawnEggItem(EntityTypeRegistry.CATERPILLAR_RAINBOW, 0xff7777, 0x0088ff, new Item.Properties().tab(CreativeModeTab.TAB_MISC)));

    private static final RegistryObject<Item> CATERPILLAR_HEATH_EGG = INSTANCE.register(Caterpillar.HEATH_NAME,
            () -> new ForgeSpawnEggItem(EntityTypeRegistry.CATERPILLAR_HEATH, 0x880000, 0x000000, new Item.Properties().tab(CreativeModeTab.TAB_MISC)));

    private static final RegistryObject<Item> CATERPILLAR_GLASSWING_EGG = INSTANCE.register(Caterpillar.GLASSWING_NAME,
            () -> new ForgeSpawnEggItem(EntityTypeRegistry.CATERPILLAR_GLASSWING, 0x880000, 0xffffff, new Item.Properties().tab(CreativeModeTab.TAB_MISC)));

    private static final RegistryObject<Item> CATERPILLAR_CHALKHILL_EGG = INSTANCE.register(Caterpillar.CHALKHILL_NAME,
            () -> new ForgeSpawnEggItem(EntityTypeRegistry.CATERPILLAR_CHALKHILL, 0x0088ff, 0x00cc55, new Item.Properties().tab(CreativeModeTab.TAB_MISC)));

    private static final RegistryObject<Item> CATERPILLAR_SWALLOWTAIL_EGG = INSTANCE.register(Caterpillar.SWALLOWTAIL_NAME,
            () -> new ForgeSpawnEggItem(EntityTypeRegistry.CATERPILLAR_SWALLOWTAIL, 0xffffff, 0xeeee77, new Item.Properties().tab(CreativeModeTab.TAB_MISC)));

    private static final RegistryObject<Item> CATERPILLAR_MONARCH_EGG = INSTANCE.register(Caterpillar.MONARCH_NAME,
            () -> new ForgeSpawnEggItem(EntityTypeRegistry.CATERPILLAR_MONARCH, 0xdd8855, 0x000000, new Item.Properties().tab(CreativeModeTab.TAB_MISC)));

    private static final RegistryObject<Item> CATERPILLAR_CABBAGE_EGG = INSTANCE.register(Caterpillar.CABBAGE_NAME,
            () -> new ForgeSpawnEggItem(EntityTypeRegistry.CATERPILLAR_CABBAGE, 0xeeee77, 0xffffff, new Item.Properties().tab(CreativeModeTab.TAB_MISC)));

    private static final RegistryObject<Item> CATERPILLAR_ADMIRAL_EGG = INSTANCE.register(Caterpillar.ADMIRAL_NAME,
            () -> new ForgeSpawnEggItem(EntityTypeRegistry.CATERPILLAR_ADMIRAL, 0x880000, 0x0088ff, new Item.Properties().tab(CreativeModeTab.TAB_MISC)));

    private static final RegistryObject<Item> CATERPILLAR_LONGWING_EGG = INSTANCE.register(Caterpillar.LONGWING_NAME,
            () -> new ForgeSpawnEggItem(EntityTypeRegistry.CATERPILLAR_LONGWING, 0x000000, 0xffffff, new Item.Properties().tab(CreativeModeTab.TAB_MISC)));

    private static final RegistryObject<Item> CATERPILLAR_CLIPPER_EGG = INSTANCE.register(Caterpillar.CLIPPER_NAME,
            () -> new ForgeSpawnEggItem(EntityTypeRegistry.CATERPILLAR_CLIPPER, 0x0044aa, 0x004488, new Item.Properties().tab(CreativeModeTab.TAB_MISC)));

    private static final RegistryObject<Item> CATERPILLAR_BUCKEYE_EGG = INSTANCE.register(Caterpillar.BUCKEYE_NAME,
            () -> new ForgeSpawnEggItem(EntityTypeRegistry.CATERPILLAR_BUCKEYE, 0xcccc88, 0x8888cc, new Item.Properties().tab(CreativeModeTab.TAB_MISC)));
}
